...
frappe.ui.form.on('Student Report Card Tool', {
	onload: function(frm) {
	...
	refresh: function(frm) {
		...
		frm.page.set_primary_action(__('Print Report Card'), () => {
			...
			if (!doc.student || !doc.assessment_group || !doc.program || !doc.academic_year) {
 			...
 			let url = "/api/method/edubliss.edubliss.doctype.student_report_card_tool.student_report_card_tool.preview_report_card";
