...
def get_context(context):
    ...
    context.active_subroute = "program_list"
    ...
    context.programs = frappe.get_all('Program', 
        filters={'custom_school': company}, 
        fields=[
        'name', 'program_name', 'program_abbreviation','department', 
        'custom_school', 'hero_image'], 
        order_by="program_abbreviation asc")
